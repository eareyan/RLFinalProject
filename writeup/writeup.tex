...
\includegraphics[page=1,width=.44\textwidth]{../results/rock_sample_results.png}}
\hspace{1mm}
\subfigure[Their results]{
\includegraphics[page=1,width=.40\textwidth]{../results/figure_6.png}}
...
\centering
\subfigure[Our results]{
\includegraphics[page=1,width=.40\textwidth]{../results/figure_2.pdf}}
\hspace{4mm}
\subfigure[Their results]{
\includegraphics[page=1,width=.30\textwidth]{../results/originalCV.pdf}}
